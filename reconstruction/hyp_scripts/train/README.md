...
fits diagnostic 3D-3D transforms, and estimates the primary relative SE(3)
observation with depth-at-t plus 2D-at-t+1 PnP so hand-contaminated target
depth cannot create a coherent false translation. It stores all confidence,
